...
class Command(BaseCommand):
    ...
    def _create_finished_tournament(self, admin: User, players: list[User]):
        ...
        tournament = Tournament.objects.create(
            ...
            event_type=Tournament.EventType.CHAMPIONSHIP,
            accent_color="#e63946",
            max_rounds=3,
            current_round=3,
    ...
    def _create_active_tournament(self, admin: User, players: list[User]):
        ...
        tournament = Tournament.objects.create(
            ...
            status=Tournament.Status.ACTIVE,            event_type=Tournament.EventType.COMPETITIVE,
            accent_color="#118ab2",            max_rounds=3,
            current_round=1,
            logo_data=_make_logo_svg(name, TOURNAMENT_COLORS[name]),
        )
